...
- `npm pack --dry-run`
- `npm pack --pack-destination /tmp/local-ai-preflight-pack-final`
- `tar -tzf /tmp/local-ai-preflight-pack-final/local-ai-preflight-kit-0.1.0.tgz`
- `/tmp` 配下で `npm init -y`
- `/tmp` 配下で `npm install /tmp/local-ai-preflight-pack-final/local-ai-preflight-kit-0.1.0.tgz`
...
- 個人環境由来の absolute-path / credential-like pattern は zero-hit を維持する
